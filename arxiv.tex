...
The easiest way to add references is to go to
\href{https://scholar.google.com/}{Google Scholar}. Click the ``Cite''
icon under the paper of interest. Copy the \textbf{BibTex} text and
paste it into the bibliography.bib file.
